            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                <div class="col">
                    <div class="card shadow">
                        <img class="img-fluid" src="{{ asset('assets/images/internships/home/Tunnel-EOIP.png') }}" alt="Tunnel EOIP MikroTik" />
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow">
                        <img class="img-fluid" src="{{ asset('assets/images/internships/home/Tunnel-IPsec.png') }}" alt="VPN IPsec Pfsense" />
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow">
                        <img class="img-fluid" src="{{ asset('assets/images/internships/home/OCS.png') }}" alt="OCS Inventory NG" />
                ...
                <div class="col">
                    <div class="card shadow">
                        <img class="img-fluid" src="{{ asset('assets/images/internships/home/PXE.png') }}" alt="PXE MikroTik" />
                        <div class="card-body">
