                            ...
                            <div class="mb-0">
                                ...
                                <div class="row row-cols-1 row-cols-md-3 mb-4">
                                    <div class="col mb-4 mb-md-0">
                                        <a class="btn d-flex align-items-center bg-light rounded-4 p-3 h-100" href="{{ route('donwloadSheetSytem') }}">
                                            Fiche projet système
                                        </a>
                                    </div>
                                    <div class="col mb-4 mb-md-0">
                                        <a class="btn d-flex align-items-center bg-light rounded-4 p-3 h-100" href="{{ route('downloadProjectSystemSamba') }}">
                                            Partie A : SAMBA AD
                                        </a>
                                    </div>
                                    <div class="col">
